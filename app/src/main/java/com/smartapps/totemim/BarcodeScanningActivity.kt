...
import com.smartapps.totemim.databinding.ActivityBarcodeScanningBinding
import java.util.concurrent.ExecutorService
import java.util.concurrent.Executors

class BarcodeScanningActivity : AppCompatActivity(), ScanningResultListener {
    ...
    private fun bindPreview(cameraProvider: ProcessCameraProvider?) {
        ...
        val analyzer: ImageAnalysis.Analyzer = MLKitBarcodeAnalyzer(this)
    ...
    override fun onScanned(result: String) {
        ...
        runOnUiThread {
            ...
            intent.putExtra("Url", "totemim.com/?barcode=XXX")
